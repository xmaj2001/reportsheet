  ...
  return (
    <SafeAreaView className="flex-1 bg-gray-50">
      ...
      <View className="flex-row justify-between items-center px-6 py-4">
        <View>
          <Text className="text-xl font-semibold text-gray-800">ReportSheet</Text>
          <Text className="text-gray-500 text-sm">How are you today?</Text>
        </View>
      ...
      <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
        ...
        <View className="flex-row justify-around px-6 mb-8">
          <ActionButton icon="arrow-up" label="Send" onPress={() => {}} />
          <ActionButton icon="arrow-down" label="Receive" onPress={() => {}} />
          <ActionButton icon="caret-down-outline" label="Withdraw" onPress={() => {}} />
      ...
      <View className="flex-row justify-around items-center py-4 bg-white border-t border-gray-200">
        ...
        <TouchableOpacity className="items-center">
          ...
          <Text className="text-xs text-gray-500 mt-1">Activity</Text>
        </TouchableOpacity>
        <TouchableOpacity className="items-center">
          <Ionicons name="card-outline" size={24} color="#6b7280" />
          <Text className="text-xs text-gray-500 mt-1">Card</Text>
        </TouchableOpacity>
        <TouchableOpacity className="items-center">
